...
public class PlaybackServiceMediaPlayer {
     ...
     *
     * @see #playMediaObject(com.kevintcoughlin.smodr.util.Playable, boolean, boolean, boolean)
     */
    ...
    private IPlayer setMediaPlayerListeners(IPlayer mp) {
        if (mp != null && media != null) {
            if (media.getMediaType() == MediaType.AUDIO) {
                ((AudioPlayer) mp)
                        .setOnCompletionListener(audioOnCompletionListener);
                ((AudioPlayer) mp)
                        .setOnSeekCompleteListener(audioSeekCompleteListener);
                ((AudioPlayer) mp)
                        .setOnErrorListener(audioErrorListener);
                ((AudioPlayer) mp)
                        .setOnBufferingUpdateListener(audioOnBufferingUpdateListener);
                ((AudioPlayer) mp)
                        .setOnInfoListener(audioInfoListener);
            }
        }
        return mp;
    }

    private final android.media.MediaPlayer.OnCompletionListener audioOnCompletionListener = new android.media.MediaPlayer.OnCompletionListener() {
        @Override
    ...
    private final android.media.MediaPlayer.OnBufferingUpdateListener audioOnBufferingUpdateListener = new android.media.MediaPlayer.OnBufferingUpdateListener() {
        @Override
    ...
    private final android.media.MediaPlayer.OnInfoListener audioInfoListener = new android.media.MediaPlayer.OnInfoListener() {
        @Override
    ...
    private final android.media.MediaPlayer.OnErrorListener audioErrorListener = new android.media.MediaPlayer.OnErrorListener() {
        @Override
    ...
    private final android.media.MediaPlayer.OnSeekCompleteListener audioSeekCompleteListener = new android.media.MediaPlayer.OnSeekCompleteListener() {
        @Override
